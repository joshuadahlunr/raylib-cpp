...
4) Create a private GitHub repository (https://www.youtube.com/watch?v=znRVAvQy5FU) and add `joshuadahlunr` and `Ap0ll02` as contributers.

5) Use `git remote add origin <your project's .git address>` in that folder to "link" it to your github repository.
...
13) Download `CMakeLists.txt` off of canvas and move it into your as0 folder: https://webcampus.unr.edu/files/15370789/download?download_frd=1
