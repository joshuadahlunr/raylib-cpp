...
int main(void)
{
    ...
    raylib::Vector2 fontPosition1(screenWidth/2 - MeasureTextEx(font1, msg1.data(), font1.baseSize, -3).x/2,
                              screenHeight/2 - font1.baseSize/2 - 80);

    raylib::Vector2 fontPosition2(screenWidth/2 - MeasureTextEx(font2, msg2.data(), font2.baseSize, -2).x/2,
                              screenHeight/2 - font2.baseSize/2 - 10);

    raylib::Vector2 fontPosition3(screenWidth/2 - MeasureTextEx(font3, msg3.data(), font3.baseSize, 2).x/2,
